...
local function run(msg, matches)
	...
	local data = load_data(_config.moderation.data)
		...
		if matches[1] == 'k' and is_owner(msg) then
			local chat_id = msg.to.id
			if matches[2] == 'aud' then
			local msg_type = 'Audio'
				if not is_muted(chat_id, msg_type..': yes') then
					savelog(msg.to.id, name_log.." ["..msg.from.id.."] set SuperGroup to: lock "..msg_type)
					mute(chat_id, msg_type)
					return msg_type.." has been locked"
				else
					return "SuperGroup mute "..msg_type.." is already on"
				end
			end
			if matches[2] == 'pht' then
			local msg_type = 'Photo'
				if not is_muted(chat_id, msg_type..': yes') then
					...
					return "SuperGroup lock "..msg_type.." is already on"
				end
			end
			...
			local msg_type = 'Gifs'
				if not is_muted(chat_id, msg_type..': yes') then
					savelog(msg.to.id, name_log.." ["..msg.from.id.."] set SuperGroup to: lock "..msg_type)
					mute(chat_id, msg_type)
					return msg_type.." have been locked"
				else
					return "SuperGroup lock "..msg_type.." is already on"
				end
			end
			if matches[2] == 'file' then
			local msg_type = 'Files'
				if not is_muted(chat_id, msg_type..': yes') then
					savelog(msg.to.id, name_log.." ["..msg.from.id.."] set SuperGroup to: lock "..msg_type)
					mute(chat_id, msg_type)
					return msg_type.." have been locked"
			...
			local msg_type = 'Chat'
				if not is_muted(chat_id, msg_type..': yes') then
					...
					return "lock "..msg_type.." is already on"
				end
			end
			...
			local msg_type = 'All'
				if not is_muted(chat_id, msg_type..': yes') then
					savelog(msg.to.id, name_log.." ["..msg.from.id.."] set SuperGroup to: lock "..msg_type)
					mute(chat_id, msg_type)
					return "lock "..msg_type.."  has been enabled"
				else
					return "lock "..msg_type.." is already on"
				end
			end
		...
		if matches[1] == 'n' and is_momod(msg) then
			...
			local msg_type = 'Audio'
				if is_muted(chat_id, msg_type..': yes') then
					savelog(msg.to.id, name_log.." ["..msg.from.id.."] set SuperGroup to: unlock "..msg_type)
					unmute(chat_id, msg_type)
					return msg_type.." has been unlocked"
				else
					return "lock "..msg_type.." is already off"
				end
			end
			if matches[2] == 'pht' then
			local msg_type = 'Photo'
			...
			local msg_type = 'Video'
				if is_muted(chat_id, msg_type..': yes') then
					savelog(msg.to.id, name_log.." ["..msg.from.id.."] set SuperGroup to: unlocked "..msg_type)
					unmute(chat_id, msg_type)
					return msg_type.." has been unlocked"
				else
					return "lock "..msg_type.." is already off"
			...
			local msg_type = 'Gifs'
				if is_muted(chat_id, msg_type..': yes') then
					savelog(msg.to.id, name_log.." ["..msg.from.id.."] set SuperGroup to: unlocked"..msg_type)
					unmute(chat_id, msg_type)
					return msg_type.." have been unlocked"
				else
					return "lock "..msg_type.." is already off"
				end
			end
			...
			local msg_type = 'Char'
				if is_muted(chat_id, msg_type..': yes') then
					savelog(msg.to.id, name_log.." ["..msg.from.id.."] set SuperGroup to: unlock message")
					unmute(chat_id, msg_type)
					return msg_type.." has been unlocked"
				else
					return "lock text is already off"
				end
			end
			if matches[2] == 'all' then
			local msg_type = 'All'
				if is_muted(chat_id, msg_type..': yes') then
					savelog(msg.to.id, name_log.." ["..msg.from.id.."] set SuperGroup to: unlock "..msg_type)
					unmute(chat_id, msg_type)
					return "lock "..msg_type.." has been disabled"
				else
					return "lock "..msg_type.." is already disabled"
				end
			end
		end
		...
		if matches[1] == 'helpa' and not is_owner(msg) then
